    ...
    <div>
      ...
      <div className="bg-[#dfe4ea] text-white min-h-screen py-12">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold mb-8 text-center text-[#303952]">
            Campaign
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2  ">
            {allCampaign.length > 0 ? (
              allCampaign.map((landpost) => (
                <div
                  key={landpost.Id}
                  className="bg-[#f4f6ff] w-80 ml-10 overflow-hidden shadow-lg transition-transform transform hover:scale-105 rounded-md"
                >
                  <div className="p-8">
                    <h3 className="text-2xl font-semibold text-[#0c1118] mb-1">
                      <span className="text-2xl">Name :</span>
                      {landpost.CampaignName}
                    </h3>
                    ...
                    <p className="text-xl font-semibold text-gray-800">
                      Location :{landpost.Location}
                    </p>
                    <br />
                    <p className="text-xl font-semibold text-gray-800">
                      Description :{landpost.Description}
                    </p>

                    {/* Action buttons */}
                    <div className="justify-center mt-5">
                      <button
                        className="bg-[#0984e3] hover:bg-blue-600 text-white px-4 py-2 rounded-md transition duration-300 cursor-pointer mr-2"
